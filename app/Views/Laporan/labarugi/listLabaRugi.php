...
<tr>
    <th width="21%"><h5>Pendapatan</h5></th>
    <th width="15%"></th>
</tr>
...
<tr>
    <th width="21%"><h5>Pendapatan Lainnya</h5></th>
    <th width="15%"></th>
</tr>
...
<tr>
    <td class="fw-bold"><h4>Total Pendapatan</h4></td>
    <td class="text-end"><h4>Rp. <?= number_format($totalPendapatan+$totalPendapatanLainnya, 0, ',', '.') ?></h4></td>
</tr>
...
<tr>
    <th width="21%"><h5>Harga Pokok Penjualan</h5></th>
    <th width="15%"></th>
</tr>
...
<tr>
    <td class="fw-bold"><h4>Total Beban</h4></td>
    <td class="text-end"><h4>Rp. <?= number_format($totalHargaPokok, 0, ',', '.') ?></h4></td>
</tr>
...
<tr>
    <th width="21%"><h5>Beban Lainnya</h5></th>
    <th width="15%"></th>
</tr>
...
<tr>
    <td class="fw-bold"><h4>Total Biaya</h4></td>
    <td class="text-end"><h4>Rp. <?= number_format($totalBeban+$totalBebanLainnya, 0, ',', '.') ?></h4></td>
</tr>
